...
<template>
  <div class="max-w-4xl">
    ...
    <div class="space-y-6">
      ...
      <!-- Full Year Fields Card (when NOT searching by installments) -->
      <div v-if="!form.search_by_installments" class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="p-6 border-b border-gray-200">
          <h3 class="text-lg font-semibold text-gray-900">Full Year Dates</h3>
          <p class="text-sm text-gray-500 mt-1">Configure dates for full year payments</p>
        </div>

        <div class="p-6">
          <div class="grid grid-cols-2 gap-6">
            <div>
              <label class="input-label">Full Year Due Date</label>
              <input
                v-model="form.full_year_due_date"
                type="text"
            ...
            <div>
              <label class="input-label">Full Year Delq Collector</label>
              <input
            ...
            <div>
              <label class="input-label">Full Year Escrow Collector</label>
              <input
            ...
            <div>
              <label class="input-label">Full Year Delinquent Search Start</label>
              <input
            ...
            <div>
              <label class="input-label">Full Year Escrow Search Start</label>
              <input
            ...
            <div>
              <label class="input-label">Full Year Tax Billing Date</label>
              <input
            ...
            <div>
              <label class="input-label">Full Year PreCommitment Date</label>
              <input
                v-model="form.full_year_precommitment_date"
                type="text"
                placeholder="MM/DD/YYYY"
                class="input"
              />
            ...
            <div>
              <label class="input-label">Full Year Finalize Balance Date</label>
              <input
                v-model="form.full_year_finalize_balance_date"
                type="text"
                placeholder="MM/DD/YYYY"
                class="input"
              />
            ...
            <div>
              <label class="input-label">Full Year Make Payment Due Date</label>
              <input
                v-model="form.full_year_make_payment_due_date"
                type="text"
                placeholder="MM/DD/YYYY"
                class="input"
              />
      ...
      <!-- Installments Card (when searching by installments) -->
      <div v-if="form.search_by_installments" class="bg-white rounded-xl border border-gray-200 shadow-sm">
