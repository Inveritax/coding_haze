...
import { Building2, Lock, User, Mail, AlertCircle, Loader2, Ticket, UserPlus } from "lucide-vue-next"
  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-primary-900 to-slate-900 flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <p class="text-slate-400">Join the Tax Research System</p>
      </div>
      ...
      <div class="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8">
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <div v-if="success" class="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/20 rounded-xl text-green-300">
            <span class="text-sm">{{ success }}</span>
          </div>

          <div>
            <label class="block text-sm font-medium text-slate-300 mb-2">Invite Code</label>
            <div class="relative">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                type="text"
                placeholder="First"
                class="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200"
              />
            </div>
            <div>
          ...
          <p class="text-center text-slate-400 text-sm mt-4">
            ...
            <router-link to="/login" class="text-primary-400 hover:text-primary-300">Sign in</router-link>
          </p>
        </form>
      </div>
